...
namespace PsP.Migrations
{
    ...
    [Migration("20251126171612_fixNav")]
    partial class fixNav
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PsP.Models.Order", b =>
                {
                    b.HasOne("PsP.Models.Business", null)
                        .WithMany("Orders")
                        .HasForeignKey("BusinessId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PsP.Models.Employee", null)
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PsP.Models.Reservation", null)
                        .WithOne("Order")
            ...
            modelBuilder.Entity("PsP.Models.OrderLine", b =>
                {
                    b.HasOne("PsP.Models.CatalogItem", null)
                        .WithMany()
                        .HasForeignKey("CatalogItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("PsP.Models.Order", null)
                        .WithMany("Lines")
            ...
            modelBuilder.Entity("PsP.Models.StockMovement", b =>
                {
                    b.HasOne("PsP.Models.OrderLine", null)
