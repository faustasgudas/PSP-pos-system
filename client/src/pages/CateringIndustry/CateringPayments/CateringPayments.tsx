...
import "../../BeautyIndustry/BeautyPayments/BeautyPayments.css";
...
export default function CateringPayments() {
                    ...
                    filtered.map((p) => (
                        <div key={p.paymentId} className="payment-card">
                            <div className="payment-main">
                                <div className="payment-amount">{formatMoney(p.amountCents, p.currency)}</div>
                            ...
                            <div className="payment-details">
                                ...
                                {p.completedAt && <div className="muted">Completed: {new Date(p.completedAt).toLocaleString()}</div>}
                            </div>
