...
import "../../BeautyIndustry/BeautyGiftCards/BeautyGiftCards.css";
...
export default function CateringGiftCards() {
    ...
    return (
        <div className="giftcards-container">
            ...
            {!isBusinessReady && <div className="no-giftcards">Missing business context (try logging in again).</div>}
            {error && <div className="giftcards-error">{error}</div>}

            <div className="giftcards-filters">
                <input className="giftcards-filter-input" placeholder="Filter by code…" value={codeFilter} onChange={(e) => setCodeFilter(e.target.value)} />
            ...
            <div className="giftcards-lookup">
                <input className="giftcards-filter-input" placeholder="Lookup by exact code…" value={lookupCode} onChange={(e) => setLookupCode(e.target.value)} />
                        ...
                        {!loading &&
                            visibleGiftCards.map((card) => (
                                <tr key={card.giftCardId} className="inventory-row">
                                    ...
                                    <td>
                                        <span className={`giftcard-status ${card.status === "Inactive" ? "blocked" : ""}`}>{card.status}</span>
                                    </td>
                                    <td className="right">{formatMoneyFromMinorUnits(card.balance, "EUR")}</td>
                                    <td className="muted">{card.expiresAt ? new Date(card.expiresAt).toLocaleDateString() : "—"}</td>
                                    <td className="right">
                    ...
                    <div className="modal-card" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-form">
                            <div className="modal-field">
                                <label>Code</label>
                                <input type="text" placeholder="e.g. GC-ABCD-1234" value={newCode} onChange={(e) => setNewCode(e.target.value)} />
                            </div>

                            <div className="modal-field">
                                <label>Initial amount (EUR)</label>
                                <input type="number" inputMode="decimal" placeholder="e.g. 25.00" value={newInitialAmount} onChange={(e) => setNewInitialAmount(e.target.value)} />
                            </div>
                    ...
                    <div className="modal-card" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-form">
                            ...
                            <div className="modal-field">
                                ...
                                <input type="number" inputMode="decimal" value={manageTopUpAmount} onChange={(e) => setManageTopUpAmount(e.target.value)} disabled={managing} />
                            ...
                            <div className="modal-field">
                                ...
                                <input type="number" inputMode="decimal" value={manageRedeemAmount} onChange={(e) => setManageRedeemAmount(e.target.value)} disabled={managing} />
